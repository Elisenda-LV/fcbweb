...
describe('PlayerCardComponent', () => {
  ...
  const mockPlayer: Player = {
    ...
    titular:
      'Defensa con gran capacidad de recuperación y visión de juego, destaca por su capacidad para sacar el balón jugado',
    comentario:
      'Destaca por su contundencia y capacidad para sacar el balón jugado.',
    imgUrl:
      'https://www.fcbarcelona.com/photo-resources/2023/10/03/414458b8-82b7-4913-a1ea-839410f6e10f/15-ANDREAS_CHRISTENSEN.jpg?width=470&height=470',
  };

  beforeEach(async () => {
    const playersServiceSpy = jasmine.createSpyObj('PlayersService', [
      'getPlayerById',
    ]);
